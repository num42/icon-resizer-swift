...
public final class AppIconResizer {
    ...
    public func run() throws {
        ...
        let resizingCommand = command(
            Option<String>("devices", default: "all", description: "The devices you need app icons for. Valid devices are iphone, ipad, watch and marketing. Use multiple devices by separating them with a comma."),
